...
import { PrismaClient, TransactionType, TransactionStatus, TransfertStatus, Compte, PorteFeuille } from '@prisma/client';
...
class TransfertController {
     ...
     */
    public static async createTransfert(req: Request, res: Response): Promise<void> {
        try {
     ...
     */
    public static async cancelTransfert(req: Request, res: Response): Promise<void> {
        try {
     ...
     */
    public static async resendTransfert(req: Request, res: Response): Promise<void> {
        try {
            const { transfertId } = req.params;
     ...
     */
    public static async getTransfertsHistory(req: Request, res: Response): Promise<void> {
        try {
